...
If a number is divisible by 20, that also implies that is divisible by 10, 5, 4, 2, and 1.
If a number is divisible by 18, that also implies that is divisible by 9, 6, 3, 2, and 1.
...
the LCD of 20, 18, 16, 15, 14, and 12 and multiply that LCD by the aforementioned prime numbers to find the
LCD of numbers 20-11.
